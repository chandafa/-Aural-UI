...
export function Navbar() {
  ...
  // Hide Navbar on docs and components pages as Sidebar takes over
      ...
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-3xl">
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            ...
            {/* Mobile Menu Button */}
            <button
              className="md:hidden h-9 w-9 inline-flex items-center justify-center rounded-full text-muted-foreground bg-muted/50 hover:bg-muted border border-border/50 transition-all relative z-50"
        ...
        {/* Mobile Menu Dropdown - Liquid Glass with Framer Motion */}
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div 
              ...
              className={cn(
                "md:hidden mt-2 mx-2 rounded-[1.5rem] backdrop-blur-3xl overflow-hidden",
                theme === "dark" 
